...
namespace Thuattoan
{
    class Program
    {
        ...
        public class Item
        {
            ...
            public double Ratio { get { return (double)Value / Weight; } }//là thuộc tính tính toán tỷ lệ giá trị trên trọng lượng
        }
        public static double GreedyKnapsack(int capacity, List<Item> items)//Sắp xếp các món đồ
        {
